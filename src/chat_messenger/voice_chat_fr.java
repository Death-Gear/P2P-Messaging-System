 ...
 * @author Risad
 */
public class voice_chat_fr extends javax.swing.JFrame {

    /**
     * Creates new form voice_chat_fr
     */
    public voice_chat_fr() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(btn_disconnect, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 153, 120, 50));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(voice_chat_fr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new voice_chat_fr().setVisible(true);
            }
        });
    }
